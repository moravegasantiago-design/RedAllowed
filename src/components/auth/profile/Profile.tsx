      ...
      <div className="w-full md:w-96 bg-zinc-900 border-r border-zinc-800 flex flex-col">
        ...
        <div className="p-6 animate-[fadeIn_0.3s_ease-out]">
          ...
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold text-white mb-1">Santiago Vega</h2>
        ...
        <div className="flex-1 px-4 space-y-2 animate-[fadeIn_0.3s_ease-out_0.1s_both]">
          ...
          <div className="bg-zinc-800/30 rounded-xl p-4 hover:bg-zinc-800/50 transition-colors cursor-pointer group">
            <div className="flex items-center gap-4">
              ...
              <svg className="w-5 h-5 text-zinc-500 group-hover:text-emerald-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-zinc-800/30 rounded-xl p-4 hover:bg-zinc-800/50 transition-colors cursor-pointer group">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-white font-medium">Desarrollador Fullstack 💻</p>
              </div>
          ...
          <div className="bg-zinc-800/30 rounded-xl p-4 hover:bg-zinc-800/50 transition-colors cursor-pointer group">
            <div className="flex items-center gap-4">
              ...
              <svg className="w-5 h-5 text-zinc-500 group-hover:text-purple-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
              </svg>
            </div>
          </div>
          ...
          <div className="bg-zinc-800/30 rounded-xl p-4 hover:bg-zinc-800/50 transition-colors cursor-pointer group">
            <div className="flex items-center gap-4">
              ...
              <svg className="w-5 h-5 text-zinc-500 group-hover:text-orange-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
              </svg>
            </div>
          </div>
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl overflow-hidden">
            ...
            <div className="p-6 pt-4">
              ...
              <p className="text-zinc-400 text-sm mb-6">
                Desarrollador Fullstack 💻 | React, Node, TypeScript | Aprendiendo algo nuevo cada día 🚀
              </p>
